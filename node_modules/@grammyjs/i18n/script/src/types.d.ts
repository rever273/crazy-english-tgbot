import { Context, FluentBundle, FluentVariable } from "./deps.js";
...
export type LocaleNegotiator<C extends Context = Context> = (ctx: C) => LocaleId | undefined | PromiseLike<LocaleId | undefined>;
